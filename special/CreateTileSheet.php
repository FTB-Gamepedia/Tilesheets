...
class CreateTileSheet extends SpecialPage {
	...
	private function buildForm() {
		...
		$form .= TileSheetForm::createFormRow('create', 'mod');
		$form .= TileSheetForm::createInputHint('create', 'mod');
		$form .= TileSheetForm::createFormRow('create', 'sizes');
		$form .= TileSheetForm::createInputHint('create', 'sizes');
		$form .= "<tr><td>".$this->msg('tilesheet-create-input')->text()."</td><td></td></td>";
		$form .= TileSheetForm::createInputHint('create', 'input');
		...
		$out = Xml::openElement('form', array('method' => 'post', 'action' => str_replace('$1', 'Special:CreateTileSheet', $wgArticlePath), 'id' => 'ext-tilesheet-create-form')) .
